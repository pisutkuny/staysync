            ...
            <div className="bg-gradient-to-r from-orange-600 via-amber-600 to-yellow-600 rounded-2xl p-8 shadow-xl">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    ...
                    <div className="flex flex-row gap-3 w-full md:w-auto">
                        ...
                        <Link href="/billing/bulk" className="flex-1 w-full">
                            <button className="w-full bg-white text-orange-700 px-4 py-2.5 rounded-lg font-bold hover:bg-orange-50 shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2 whitespace-nowrap border border-white/30 hover:scale-105 text-sm">

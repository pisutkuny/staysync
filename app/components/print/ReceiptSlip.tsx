    ...
    return (
        <div className="w-[80mm] bg-white p-4 mx-auto text-black font-sans text-xs leading-relaxed relative">
            ...
            <div className="text-center mb-4 pb-4 border-b-2 border-dashed border-black">
                ...
                <p className="text-[10px] text-black mt-1 px-2 leading-snug">{config.dormAddress}</p>
            </div>

            {/* Document Details */}
            <div className="flex justify-between items-end mb-4 text-[10px] text-black font-medium">
            ...
            <div className="mb-4">
                <table className="w-full text-right">
                    <thead className="text-[9px] text-black border-b border-black">
                        <tr>
            ...
            {/* Total */}
            <div className="border-t-2 border-dashed border-black pt-3 pb-6 mb-2">
            ...
            {/* Footer */}
            <div className="text-center text-[9px] text-black space-y-1">
